...
export function HeroAnimations() {
  const [randomArr] = useState<number[]>(() => Array.from({ length: 20 }).map(() => Math.random()));
  ...
  return (
    <>
      ...
      <motion.div
        animate={floatingAnimation as unknown as { y: number[] }}
      ...
      >
        <img
          ...
          alt="Glass cube"
          className="h-full w-full object-contain drop-shadow-[0_25px_80px_rgba(124,58,237,0.45)]"
        />
