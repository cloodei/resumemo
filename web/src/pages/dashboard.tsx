...
import { dashboardMetrics, dashboardRecentSessions, detectAuthProvider, getProviderBadge } from "@/components/features/dashboard/dashboard-utils"
	...
	return (
		<div className="flex flex-col gap-8">
			...
			<section className="grid gap-6 lg:grid-cols-[2fr_1fr]">
				<DashboardRecentSessions sessions={dashboardRecentSessions} />
