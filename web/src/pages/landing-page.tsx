	...
	return (
		<div className="min-h-screen bg-[#060608] text-white selection:bg-[#C95D42] selection:text-white">
			...
			<div className="pointer-events-none fixed inset-0 z-0">
				<div className="absolute inset-0 bg-[radial-gradient(ellipse_at_24%_8%,rgba(201,93,66,0.16),transparent_30%),radial-gradient(ellipse_at_72%_36%,rgba(244,192,109,0.12),transparent_34%),radial-gradient(ellipse_at_18%_78%,rgba(125,211,252,0.1),transparent_36%),linear-gradient(180deg,#050507_0%,#08080b_42%,#050507_100%)]" />
				<div className="absolute inset-0 opacity-[0.12] bg-[linear-gradient(to_right,rgba(255,255,255,0.22)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.16)_1px,transparent_1px)] bg-size-[72px_72px]" />
				<div className="landing-grid-drift absolute inset-x-[-18%] top-[-4%] h-[58vh] -rotate-2 opacity-[0.38] mask-[linear-gradient(105deg,transparent_0%,black_12%,black_76%,transparent_100%)] bg-[linear-gradient(to_right,rgba(244,192,109,0.22)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.18)_1px,transparent_1px)] bg-size-[92px_54px]" />
				<div className="landing-grid-drift absolute left-[-8%] top-[22%] h-[54vh] w-[82vw] rotate-[4deg] opacity-[0.25] [animation-delay:-6s] mask-[linear-gradient(90deg,transparent_0%,black_10%,black_84%,transparent_100%)] bg-[linear-gradient(to_right,rgba(125,211,252,0.22)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.15)_1px,transparent_1px)] bg-size-[48px_82px]" />
				<div className="landing-grid-drift absolute right-[-14%] top-[56%] h-[56vh] w-[88vw] rotate-[-5deg] opacity-[0.29] [animation-delay:-11s] mask-[radial-gradient(ellipse_at_center,black_0%,black_54%,transparent_88%)] bg-[linear-gradient(to_right,rgba(201,93,66,0.24)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.16)_1px,transparent_1px)] bg-size-[118px_66px]" />
				<div className="absolute inset-0 opacity-[0.12] mask-[linear-gradient(180deg,black,transparent_24%,black_48%,transparent_74%,black)] bg-[linear-gradient(115deg,transparent_0%,transparent_46%,rgba(255,255,255,0.18)_47%,transparent_48%,transparent_100%)] bg-size-[420px_280px]" />
				<div className="absolute inset-0 opacity-[0.09] bg-[radial-gradient(rgba(255,255,255,0.34)_1px,transparent_1px)] bg-size-[26px_26px]" />
				<div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(6,6,8,0.05)_0%,rgba(6,6,8,0.34)_34%,rgba(6,6,8,0.1)_58%,rgba(6,6,8,0.46)_100%)]" />
