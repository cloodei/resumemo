...
// import { ArrowRight, Sparkles, Zap, Target, BarChart3, ArrowUpRight } from "lucide-react"
...
//         if (newResumes === 10000 && newCompanies === 500 && newTimeSaved === 90) {
...
//       <svg id="noise" className="absolute inset-0 z-10 h-full w-full opacity-30">
...
//             <span className="text-xs font-medium text-purple-200">Lightning Fast</span>
//           </div>
//         </motion.div>
...
//             <span className="text-xs font-medium text-blue-200">Precise Matching</span>
//           </div>
//         </motion.div>
...
//             <span className="text-xs font-medium text-indigo-200">AI-Powered</span>
//           </div>
//         </motion.div>
//       </div>
...
//                 <span className="font-semibold text-white">500+</span> companies already using
//               </span>
