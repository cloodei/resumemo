...
LOCAL_CHROMA_DB_PATH = PIPELINE_ROOT / "data" / "chroma_db"
RESEARCH_CHROMA_DB_PATH = REPO_ROOT / "research" / "data" / "chroma_db"
DEFAULT_CHROMA_DB_PATH = LOCAL_CHROMA_DB_PATH if LOCAL_CHROMA_DB_PATH.exists() else RESEARCH_CHROMA_DB_PATH
PIPELINE_CHROMA_DB_PATH = Path(
    os.environ.get("PIPELINE_CHROMA_DB_PATH", str(DEFAULT_CHROMA_DB_PATH))
)
...
RESUME_SEGMENTATION_WORD_THRESHOLD = int(os.environ.get("RESUME_SEGMENTATION_WORD_THRESHOLD", "2000"))
