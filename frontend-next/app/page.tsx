...
import { ArrowRight, Layers, PenTool, ShieldCheck, Sparkles, Zap, Check, ChevronRight } from 'lucide-react';
      ...
      <header className="fixed top-0 z-50 w-full border-b border-white/5 bg-surface/80 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-5xl items-center justify-between px-4 sm:px-6">
          ...
          <nav className="hidden items-center gap-8 md:flex">
            ...
            <Link href="#workflow" className="text-sm text-slate-400 transition-colors hover:text-white">How it works</Link>
            <Link href="#testimonials" className="text-sm text-slate-400 transition-colors hover:text-white">Testimonials</Link>
          </nav>
            ...
            >
              <div className="grid lg:grid-cols-2">
                ...
                <motion.div variants={fadeInUp} className="p-8 sm:p-12">
                  <p className="text-sm font-medium uppercase tracking-widest text-brand/70">
                    Get started
                  </p>
